...
export default function StatusCard({ bmi, bmiNumber, className = "", }: StatusCardProps) {
    return(
        <div className={`flex min-h-[170px] flex-col items-center justify-center rounded-[28px] bg-white p-6 shadow-xl ${className}`}>
